...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (Fr_toInt(&lvar[15]) + Fr_toInt(&lvar[18]))) + 35)]);
}
{
PFrElement aux_dest = &lvar[20];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (Fr_toInt(&lvar[16]) + Fr_toInt(&lvar[18]))) + 35)]);
}
...
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[18])) + 15)],&circuitConstants[0]); // line circom 59
if(Fr_isTrue(&expaux[0])){
...
Fr_neq(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 15)],&circuitConstants[0]); // line circom 65
...
Fr_lt(&expaux[0],&lvar[14],&circuitConstants[5]); // line circom 78
while(Fr_isTrue(&expaux[0])){
Fr_leq(&expaux[0],&lvar[((1 * Fr_toInt(&lvar[14])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 20)]); // line circom 80
...
assert(Fr_isTrue(&expaux[0]));
Fr_leq(&expaux[0],&lvar[((1 * Fr_toInt(&lvar[14])) + 5)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 25)]); // line circom 81
...
assert(Fr_isTrue(&expaux[0]));
Fr_add(&expaux[1],&lvar[((1 * Fr_toInt(&lvar[14])) + 0)],&lvar[((1 * Fr_toInt(&lvar[14])) + 5)]); // line circom 84
...
Fr_sub(&expaux[2],&circuitConstants[4],&lvar[14]); // line circom 89
Fr_sub(&expaux[3],&circuitConstants[4],&lvar[14]); // line circom 89
...
PFrElement aux_dest = &lvar[13];
// load src
Fr_add(&expaux[0],&lvar[((1 * Fr_toInt(&lvar[14])) + 0)],&lvar[((1 * Fr_toInt(&lvar[14])) + 5)]); // line circom 90
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &lvar[14];
// load src
Fr_add(&expaux[0],&lvar[14],&circuitConstants[1]); // line circom 78
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[14],&circuitConstants[5]); // line circom 78
...
Fr_lt(&expaux[0],&lvar[14],&circuitConstants[5]); // line circom 102
while(Fr_isTrue(&expaux[0])){
Fr_neq(&expaux[0],&lvar[14],&lvar[11]); // line circom 103
if(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 90)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 15)]); // line circom 104
...
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 90)],&circuitConstants[0]); // line circom 106
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 0)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 20)]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 5)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 25)]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[14])) + 10)];
// load src
// end load src
...
PFrElement aux_dest = &lvar[14];
// load src
Fr_add(&expaux[0],&lvar[14],&circuitConstants[1]); // line circom 102
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[14],&circuitConstants[5]); // line circom 102
